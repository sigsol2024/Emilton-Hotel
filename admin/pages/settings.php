    ...
    <div class="card">
        ...
        <div style="padding: 20px;">
            <div class="form-group">
                ...
                <textarea id="footer_address" name="footer_address" rows="2"><?= sanitize($settings['footer_address'] ?? '11 Akpofe Street, Ajao Estate, Off Int\'l Airport Road.') ?></textarea>
                <p class="form-help">This address will be displayed in the footer with a location icon</p>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="email" id="footer_email" name="footer_email" value="<?= sanitize($settings['footer_email'] ?? '') ?>">
                <p class="form-help">Email address displayed in the footer contact section</p>
            </div>
            
            <div class="form-group">
                <label for="footer_phone">Phone Number(s)</label>
                <input type="text" id="footer_phone" name="footer_phone" value="<?= sanitize($settings['footer_phone'] ?? '+234 813 480 7718 | +234 907 676 0923') ?>">
            ...
            <div class="form-group">
                ...
                <input type="email" id="contact_email" name="contact_email" value="<?= sanitize($settings['contact_email'] ?? $settings['footer_email'] ?? '') ?>">
    ...
    <div class="card">
        ...
        <div style="padding: 20px;">
            ...
            <div class="form-group">
                ...
                <input type="text" id="smtp_from_name" name="smtp_from_name" value="<?= sanitize($settings['smtp_from_name'] ?? ($settings['site_name'] ?? 'Hotel Contact Form')) ?>" placeholder="Hotel Name">
