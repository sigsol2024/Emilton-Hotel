        ...
        <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #e5e7eb;">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" id="rating_score" name="rating_score" class="form-control" step="0.1" min="0" max="10" placeholder="5.0">
                    <p class="form-help">Displayed with star icon on room details page</p>
                </div>
                <div class="form-group">
                    <label for="size">Size (e.g., "45 m² / 484 ft²")</label>
                    <input type="text" id="size" name="size" class="form-control" placeholder="45 m² / 484 ft²">
